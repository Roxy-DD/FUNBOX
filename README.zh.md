...
### 🎛️ 管理后台
- [x] **可视化数据管理** - React 管理面板，支持 Projects/Skills/Timeline 的 CRUD 操作
- [x] **实时编辑** - 直接在浏览器中编辑数据，无需手动修改文件
- [x] **自动备份** - 每次保存自动创建备份文件
- [x] **数据同步** - 一键同步 JSON 数据到 TypeScript 文件
- [x] **Git 集成** - 支持版本控制和自动提交
- [x] **搜索筛选** - 强大的搜索和多维度筛选功能
- 📖 [管理后台使用指南](docs/ADMIN_GUIDE.md)
...
| `pnpm admin`               | 启动管理后台（端口 3000 和 5173）       |
